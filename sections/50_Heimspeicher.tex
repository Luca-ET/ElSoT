...
\subsection{Betriebsstrategien für Heimspeichersysteme}

\begin{itemize}
    \item PV-Eigenverbrauchssteigerung
    \item Reduktion der Netzbezugsleistung (Peak Shaving)
    \item Reduktion der Netzeinspeiseleistung
    \item Ausnutzung von Tarifunterschieden (Arbitrage)
    \item Schwarmspeicher / Pooling von Speichern, um Systemdienstleistungen zur Verfügung zu stellen (insbesondere Regelleistung)
    \item (Betriebsstrategien zur Verlängerung der Lebensdauer)
\end{itemize}
...
\begin{centering}
    \includegraphics[width=0.9\linewidth]{images/Reduktion_Netzbezugsleistung.png}
\end{centering}
\vspace{-0.1cm}
\begin{itemize}
...
\subsubsection{... durch Wärmepumpe und Batterie}
...
\vspace{0.15cm}
\begin{centering}
\includegraphics[width=0.9\linewidth]{images/Durch_Wärmepumpen_und_Batterien_1.png}
\textcolor{blue}{Reduktion Bezugspitzen auf 3kW mit Batterie}\\
\textcolor{yellow}{HH-Stromprofil}\\
\textcolor{grey}{Steuerung WP}\\
\end{centering}
\vspace{0.15cm}
...
\begin{minipage}[ht]{0.52\columnwidth}
\raggedright
    \textbf{Konventionelle Speicherung}\\
    \includegraphics[height=2.2cm]{images/Konventionelle_Speicherung.png} 
\end{minipage}
\begin{minipage}[ht]{0.5\columnwidth}
\raggedright
    \textbf{Netzoptimierte Speicherung}\\
    \includegraphics[height=2.2cm]{images/Netzoptimierte_Speicherung.png}
\end{minipage}
...
\includegraphics[width=0.9\linewidth]{images/Reduktion_der_Netzeinspeiseleistung.png}
...
\textcolor{red}{\textbf{Hinweis:} Je kürzer die Lithium-Batterie vollständig geladen ist, desto langsamer altert sie.}
